...
match = {1:[0,0] , 2:[0,1], 3:[0,2] ,4:[1,0], 5:[1,1], 6:[1,2], 7:[2,0], 8:[2,1], 9:[2,2]} #숫자와 접근하고자 하는 맵의 좌표 매칭 
AI_set_1 = [1,3,7,9]
AI_set_2 = [2,4,6,8]
AI_set_3 = [5]
...
def draw_map():
    print("="*13)
    print("= "+(MAP[0][0] if MAP[0][0]!=0 else " ")+" = "+(MAP[0][1] if MAP[0][1]!=0 else " ")+" = "+(MAP[0][2] if MAP[0][2]!=0 else " ")+" =")
    print("="*13)
    print("= "+(MAP[1][0] if MAP[1][0]!=0 else " ")+" = "+(MAP[1][1] if MAP[1][1]!=0 else " ")+" = "+(MAP[1][2] if MAP[1][2]!=0 else " ")+" =")
    print("="*13)
    print("= "+(MAP[2][0] if MAP[2][0]!=0 else " ")+" = "+(MAP[2][1] if MAP[2][1]!=0 else " ")+" = "+(MAP[2][2] if MAP[2][2]!=0 else " ")+" =")
    print("="*13)
...
def judge_win(Map):
    if (Map[0][0]==Map[0][1]==Map[0][2]!= 0) or (Map[1][0]==Map[1][1]==Map[1][2]!=0) or (Map[2][0]==Map[2][1]==Map[2][2]!=0) or (Map[0][0]==Map[1][0]==Map[2][0]!=0) or (Map[0][1]==Map[1][1]==Map[2][1]!=0) or (Map[0][2]==Map[1][2]==Map[2][2]!=0) or (Map[0][0]==Map[1][1]==Map[2][2]!=0) or (Map[2][0]==Map[1][1]==Map[0][2]!=0):
        return 1
    else:
        return 0
