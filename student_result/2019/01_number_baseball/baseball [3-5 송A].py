...
def form_pw():
    ...
    pw = random.sample(number_list, 3) # pw: number_list에서 세 숫자
    return pw
...
def hints(guess, pw):
    ...
    ans_s = 0  # strike인 숫자 개수 카운트
    ans_b = 0  # ball인 숫자 개수 카운트
    ans_o = 0  # out인 숫자 개수 카운트
    ...
    #   str: int형태와 문자 형태를 이어 붙이기 위해 사용
