...
def guess_check():
    ...
    elif 10 <= user_guess[0] < 100:  # 숫자가 공백 없이 입력받아졌는데 맨 앞자리가 0인 경우
        temp = user_guess[0]
        del user_guess[0]
        user_guess.append(0)
        user_guess.append(temp // 10)
