...
def sbo(secret_number, assume_number):
    ...
    if strike == 3:
        return 999, print("Congratulation!")  # 숫자 999를 while 문을 빠져나오기 위한 flag 로 둠
...
def game_start():
    ...
    while trial > 0:
        ...
        try:
            ...
            # 0~9 이내의 정수가 아닌 수(소수점, 한자, 영문, 음수)를 입력하면 raise exception 으로 강제 오류 발생
        ...
        except:  # T. 예외를 발생할때에는 어떠한 에러를 잡아야 하는지 명기해야 한다.
            print("다시 입력하세요")
