...
page_url = 'https://movie.naver.com/movie/bi/ti/running.nhn?code=402&sdate=' + \
    str(tomorrow)  # 네이버 영화 - 내일 메가박스 세종의 상영시간표 접속
...
print(tomorrow[0] + '년 ' + tomorrow[1] + '월 ' +
      tomorrow[2] + '일 상영시간표')  # 상영시간표 정보 제공 - 날짜 출력
