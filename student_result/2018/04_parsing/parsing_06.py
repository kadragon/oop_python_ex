...
while True:
    ...
    # 현재 분실물 페이지
    current_page = get_html_text(
        sess, 'https://go.sasa.hs.kr/board/lists/2/page/%d' % count)
    ...
    for title in title_list:
        ...
        # 아니라면
            ...
            text = new_soup.select_one(
                'div.content-wrapper section.content div.box-body').getText().strip()
