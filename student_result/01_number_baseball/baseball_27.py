...
def play():
    ...
    while S != 3 and guessesTaken <= 10:
        ...
        if S==0 and B == 0: print("OUT")
        else: print("%d S | %d B"%(S,B))
    if S == 3: print("Great! You did a job for %d times." %guessesTaken)
    else: print("Oh no! You failed for 10 times. Try again!")
