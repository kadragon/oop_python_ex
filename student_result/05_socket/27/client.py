...
print("-"*60)
print("한글 맞춤법 중 단어 차원의 오류 테스트입니다.")
print("문장이 제시되면 괄호 안 단어의 맞는 형태를 적어주세요.")
print("틀린 게 없다면 그대로 적어야 겠죠?\n")
print("예시) 그는 내가 (일찌기) 알지 못했던 세계를 나에게 보여 주었다.")
a = input()
if a == '일찍이':
    print("정답!")
else:
...
def receive():
    ...
    while True:
        try:
            data = mysock.recv(1024)  # 서버로부터 값을 받는것
