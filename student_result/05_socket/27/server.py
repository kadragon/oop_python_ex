        ...
        try:
            ...
            break
             ...
             if data in problems_and_answers[num][1].split('/'):
                ...
                client_sock.send(bytes("답 : " + problems_and_answers[num][1], 'utf-8'))
             num += 1
