...
print("If you want to end game, just type 'game end'")
print("Start word = 'python'")
print("시작할 때 아무버튼이나 누르면 자신의 번호를 알 수 있습니다")
print("자신의 차례라면 번호와 오답이 뜰 것이고, 자신의 차례가 아니라면 번호과 자신의 차례가 아니라는 메세지가 나옵니다.\n")
